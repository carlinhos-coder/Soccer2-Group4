...
namespace Soccer.Web.Helpers
{
    public interface IConverterHelper
    {
        ...
        TournamentResponse ToTournamentResponse(TournamentEntity tournamentEntity);//se hace la conversion de los response

        List<TournamentResponse> ToTournamentResponse(List<TournamentEntity> tournamentEntities);//devuelve la lista que vamos a usarS
    }
}

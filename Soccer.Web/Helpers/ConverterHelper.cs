    ...
    public class ConverterHelper : IConverterHelper
    {
        ...
        public TournamentResponse ToTournamentResponse(TournamentEntity tournamentEntity)
        {
            return new TournamentResponse
            {
                ...
                Name = tournamentEntity.Name,
                StartDate = tournamentEntity.StartDate,
                Groups = tournamentEntity.Groups?.Select(g => new GroupResponse//por cada grupo crea un gropresponse
                {
                    Id = g.Id,
                    Name = g.Name,
                    ...
                    Matches = g.Matches?.Select(m => new MatchResponse
                    {
                        ...
                        Predictions = m.Predictions?.Select(p => new PredictionResponse//valida si los elementos son nulos
                        {
